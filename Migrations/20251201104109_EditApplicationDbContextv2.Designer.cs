...
namespace DeBillPay_Backend.Migrations
{
    ...
    [Migration("20251201104109_EditApplicationDbContextv2")]
    partial class EditApplicationDbContextv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeBillPay_Backend.Models.EbillHistory", b =>
                {
                    b.Property<int>("EbillHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EbillHistoryId"));
                    ...
                    b.HasKey("EbillHistoryId");

                    b.HasIndex("EbillId");

                    b.ToTable("EbillHistories");
                });
            ...
            modelBuilder.Entity("DeBillPay_Backend.Models.EbillParticipant", b =>
                {
                    ...
                    b.Property<bool>("IsEditorRights")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("DeBillPay_Backend.Models.EbillHistory", b =>
                {
                    b.HasOne("DeBillPay_Backend.Models.Ebill", null)
                        .WithMany("History")
                        .HasForeignKey("EbillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
